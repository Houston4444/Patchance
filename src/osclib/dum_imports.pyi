...
class Bundle:
    @overload
    def __init__(self, timetag: float, *messages: Message) -> None: ...
    @overload
    def __init__(self, *messages: Message): ...

    @overload
    def add(self, path: str, *messages: Message): ...
    @overload
    def add(self, *args: tuple): ...
...
class Address:
    ...
    @overload
    def __init__(self, hostname: str, port: int | str, proto: int =UDP): ...
    @overload
...
class __AbstractServer:
    ...
    def __init__(self, port: int | str =1, proto: int =UDP, reg_methods=True): ...
    def recv(self, timeout: int | None =None) -> bool: ...
    ...
    @overload
    def send(self, address: Address | str | int, path: str, *args): ...
    @overload
...
@overload
def send(target: Address | int | tuple[str, int] | str,
         path: str,
         *args: str | float | int | bytes | bool): ...
@overload
def send(target: Address | int | tuple[str, int] |str,
         *messages: Message): ...
